...
func (sc *ServiceClient) SendInApp(ctx context.Context, url string, traceID string) (string, error) {
	span, _ := opentracing.StartSpanFromContext(ctx, "serviceclient.SendInApp")
	defer span.Finish()
